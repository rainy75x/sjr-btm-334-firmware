...
#                                                          
# Project: sink
# Configuration: Speaker_Broadcast
# Generated: Tue 26. May 15:29:46 2026
#                                                          
...
BUILDOUTPUT_PATH=depend_Speaker_Broadcast_qcc512x_qcc302x
...
DEFS=__KALIMBA__ HAVE_32BIT_DATA_WIDTH INSTALL_HYDRA_LOG BLUELAB HYDRACORE BROADCAST_PACKETISER_IS_CONTROLLED_BY_APP TRAPSET_CORE=1 TRAPSET_PSU=1 AFH_UPDATE_METHOD_SYNC_TRAIN ENABLE_AHI_USB_HOST ENABLE_BATTERY_OPERATION ENABLE_CHARGER_V2 ENABLE_USB_TYPE_C BLE_ENABLED_WHEN_OFF DEVICE_ID_PSKEY ENABLE_DISPLAY ENABLE_DISPLAY_MIDAS ENABLE_AUDIO_CLOCK ENABLE_AUDIO_TTP ENABLE_AVRCP ENABLE_BREDR_SC ENABLE_DORMANT_SUPPORT ENABLE_DOWNLOADABLE_CAPS GATT_IAS_CLIENT ENABLE_GAIA GATT_ENABLED GATT_ANCS_CLIENT GATT_BATTERY_SERVER GATT_FP_SERVER GATT_IAS_SERVER GATT_BATTERY_SERVER_PEER GATT_IAS_SERVER GATT_LLS_SERVER GATT_TPS_SERVER GATT_BATTERY_SERVER_REMOTE GATT_BATTERY_CLIENT GATT_DIS_CLIENT GATT_SPC_CLIENT GATT_HID_CLIENT ENABLE_PBAP ENABLE_BROADCAST_AUDIO ENABLE_UPGRADE ENABLE_USB ENABLE_USB_AUDIO ENABLE_USB_HID_UPGRADE ENABLE_WATCHDOG ENABLE_WIRED GATT_GAIA_SERVER INCLUDE_APTX_ACL_SPRINT INCLUDE_DSP THREE_WAY_CALLING ENABLE_USB_AUDIO_APP_STEREO_DESCRIPTORS ENABLE_USB_HUB_SUPPORT
EXTRA_WARNINGS=FALSE
FLASH_CONFIG=..\..\64Mbit_default_flash_config.py
HW_VARIANT=QCC3034-AA_DEV-BRD-R2-AA
IDE_CONFIG=Speaker_Broadcast
IDE_PROJECT=sink
